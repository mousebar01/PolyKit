...
interface Props {
  ...
  onAudioUnlock?: () => void;
  draftKey?: string;
  /** Session working directory — used to scope project skills */
  cwd?: string | null;
...
// dormancy map fetched from the PolyKit /agent/skills boundary. Unknown skills are treated as active.
...
export const ChatInput = forwardRef<ChatInputHandle, Props>(function ChatInput({
  ...
  const handleKeyDown = useCallback(
    ...
    [isStreaming, onSteer, onFollowUp, onAbort, slashMenuOpen, slashQuery, displayedSlashCommands, slashActiveIndex, applySlashCommand, sendQueued, handleSend, getNextSlashIndex, historyMenuOpen, inputHistory, historyActiveIndex, applyHistoryInput, value]
  );
  ...
  useEffect(() => {
    ...
    fetch(agentApiPath(`/skills?cwd=${encodeURIComponent(requestCwd)}`))
      .then((res) => {
        ...
        <div style={{ position: "relative", minWidth: 0 }}>
          ...
          <div
            ...
            style={{
              ...
              // Keep the composer distinct from the page surface so the
              // input reads as a contained control.
              background: "var(--bg-panel)",

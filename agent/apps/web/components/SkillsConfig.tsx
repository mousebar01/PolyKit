...
function AddSkillPanel({
  ...
  const search = useCallback(async (q: string) => {
    ...
    setResults([]);
    try {
      const res = await fetch(agentApiPath("/skills/search"), {
        method: "POST",
  ...
  const install = useCallback(
    async (pkg: string) => {
      ...
      try {
        const res = await fetch(agentApiPath("/skills/install"), {
          method: "POST",
          headers: { "Content-Type": "application/json" },
...
export function SkillsConfig({
  ...
  const loadSkills = useCallback(async () => {
    ...
    setError(null);
    try {
      const res = await fetch(`${agentApiPath("/skills")}?cwd=${encodeURIComponent(cwd)}`);
  ...
  const checkForUpdates = useCallback(async (skill?: Skill) => {
    ...
    try {
        const res = await fetch(agentApiPath("/skills/check"), {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          cwd,
  ...
  const updateInstalledSkill = useCallback(async (skill: Skill) => {
    ...
    setUpdateError(null);
    try {
      const res = await fetch(agentApiPath("/skills/update"), {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          cwd,
  ...
  const toggle = useCallback(async (skill: Skill) => {
    ...
    setSaveError(null);
    try {
      const res = await fetch(agentApiPath("/skills"), {
        method: "PATCH",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({

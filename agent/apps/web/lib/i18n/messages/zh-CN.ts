...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.thinking": "正在思考...",
    "chat.thought": "已思考",
    "chat.thoughtSeconds": "已思考 {seconds}秒",
    "chat.thoughtMinutes": "已思考 {minutes}分{seconds}秒",
    "chat.deepDiving": "正在深入思考...",
    "chat.processDetails": "处理详情",
    "chat.working": "正在工作",
    "chat.scrollToBottom": "滚动到对话底部",
    "chat.scrollToRunning": "查看正在生成的内容",
    "chat.turnNavigation": "对话轮次导航",
    "chat.searchConversation": "搜索当前对话",
    "chat.searchConversationPlaceholder": "搜索当前对话…",
    "chat.searchConversationHint": "搜索本次对话中的用户问题和最终回答。",
    "chat.searchResults": "对话搜索结果",

...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "chat.thoughtSeconds": "Thought for {seconds}s",
    "chat.thoughtMinutes": "Thought for {minutes}m {seconds}s",
    ...
    "chat.turnNavigation": "Conversation turn navigation",
    "chat.searchConversation": "Search conversation",
    "chat.searchConversationPlaceholder": "Search this conversation…",
    "chat.searchConversationHint": "Search user prompts and final answers in this conversation.",
    "chat.searchResults": "Conversation search results",
